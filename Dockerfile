...
RUN --mount=type=cache,target=/root/.cache \
  ...
  && go build -o /app/bin/anubis -ldflags="-X github.com/EnderNon/anubis-icon-gaming.Version=${VERSION}" ./cmd/anubis
...
LABEL org.opencontainers.image.source="https://github.com/EnderNon/anubis-icon-gaming"
